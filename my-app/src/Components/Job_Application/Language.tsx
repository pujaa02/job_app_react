                            ...
                            <fieldset className="fieldset form-control" style={{ width: 400 }}>
                                ...
                                <div className="container_language">
                                    ...
                                    <div className="row">
                                        <div className="col">
                                            <div className="form-check">
                                                <input className="form-check-input" type="checkbox" value="hindi" id="hindi" {...register("hindi", {
                                                    validate: () => validateLanguage("hindi", ["read1"], ["write1"], ["speak1"]),
                                                })} />
                                        ...
                                        <div className="col"><input className="form-check-input" type="checkbox" value="read" id="read1" {...register("read1", {
                                            validate: () => validateLanguage("hindi", ["read1"], ["write1"], ["speak1"]),
                                        })} /><label className="form-check-label">read</label></div>
                                        <div className="col"><input className="form-check-input" type="checkbox" value="write" id="write1" {...register("write1", {
                                            validate: () => validateLanguage("hindi", ["read1"], ["write1"], ["speak1"]),
                                        })} /><label className="form-check-label">write</label></div>
                                        <div className="col"><input className="form-check-input" type="checkbox" value="speak" id="speak1" {...register("speak1", {
                                            validate: () => validateLanguage("hindi", ["read1"], ["write1"], ["speak1"]),
                                        })} /><label className="form-check-label">Speak</label></div>
                                    </div>
                                        ...
                                        <div className="col">
                                            <div className="form-check">
                                                <input className="form-check-input" type="checkbox" value="english" id="english" {...register("english", {
                                                    validate: () => validateLanguage("english", ["read2"], ["write2"], ["speak2"]),
                                                })} />
                                                <label className="form-check-label">English</label>
                                                {errors.english && <span className="error-message">{(errors.english as FieldError).message}</span>}
                                            </div>
                                        </div>
                                        <div className="col"><input className="form-check-input" type="checkbox" value="read" id="read2" {...register("read2", {
                                            validate: () => validateLanguage("english", ["read2"], ["write2"], ["speak2"]),
                                        })} /><label className="form-check-label">read</label></div>
                                        <div className="col"><input className="form-check-input" type="checkbox" value="write" id="write2" {...register("write2", {
                                            validate: () => validateLanguage("english", ["read2"], ["write2"], ["speak2"]),
                                        })} /><label className="form-check-label">write</label></div>
                                        <div className="col"><input className="form-check-input" type="checkbox" value="speak" id="speak2" {...register("speak2", {
                                            validate: () => validateLanguage("english", ["read2"], ["write2"], ["speak2"]),
                                        })} /><label className="form-check-label">Speak</label></div>
                                    </div>
                                    <div className="row">
                                        <div className="col">
                                            <div className="form-check">
                                                <input className="form-check-input" type="checkbox" value="gujarati" id="gujarati" {...register("gujarati", {
                                                    validate: () => validateLanguage("gujarati", ["read3"], ["write3"], ["speak3"]),
                                                })} />
                                        ...
                                        <div className="col"><input className="form-check-input" type="checkbox" value="read" id="read3" {...register("read3", {
                                            validate: () => validateLanguage("gujarati", ["read3"], ["write3"], ["speak3"]),
                                        })} /><label className="form-check-label">read</label></div>
                                        <div className="col"><input className="form-check-input" type="checkbox" value="write" id="write3" {...register("write3", {
                                            validate: () => validateLanguage("gujarati", ["read3"], ["write3"], ["speak3"]),
                                        })} /><label className="form-check-label">write</label></div>
                                        <div className="col"><input className="form-check-input" type="checkbox" value="speak" id="speak3" {...register("speak3", {
                                            validate: () => validateLanguage("gujarati", ["read3"], ["write3"], ["speak3"]),
                                        })} /><label className="form-check-label">Speak</label></div>
                                    </div>
                                </div>
                            ...
                            <fieldset className="fieldset form-control" style={{ width: 500 }}>
                                ...
                                <div className="container_language_language">
                                    <div className="row">
                                        ...
                                        <div className="col">
                                            <input className="form-check-input" type="radio" {...register("level1", {
                                                validate: () => validateTechnology("php", "level1"),
                                            })} id="beg1" value="beginner" />
                                            <label className="form-check-label">Beginner</label>
                                        </div>
                                        <div className="col">
                                            <input className="form-check-input" type="radio" {...register("level1", {
                                                validate: () => validateTechnology("php", "level1"),
                                            })} id="mid1" value="mideator" />
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col">
                                            <input className="form-check-input" type="radio" {...register("level2", {
                                                validate: () => validateTechnology("mysql", "level2"),
                                            })} id="beg2" value="beginner" />
                                            <label className="form-check-label">Beginner</label>
                                        </div>
                                        <div className="col">
                                            <input className="form-check-input" type="radio" {...register("level2", {
                                                validate: () => validateTechnology("mysql", "level2"),
                                            })} id="mid2" value="mideator" />
                                            <label className="form-check-label">Mideator</label>
                                        </div>
                                        <div className="col">
                                            <input className="form-check-input" type="radio" {...register("level2", {
                                    ...
                                    <div className="row">
                                        <div className="col">
                                            <input className="form-check-input" type="checkbox" value="laravel" id="laravel" {...register("laravel", {
                                                validate: () => validateTechnology("laravel", "level3"),
                                            })} />
                                        ...
                                        <div className="col">
                                            <input className="form-check-input" type="radio" {...register("level3", {
                                                validate: () => validateTechnology("laravel", "level3"),
                                            })} id="beg3" value="beginner" />
                                            <label className="form-check-label">Beginner</label>
                                        </div>
                                        <div className="col">
                                            <input className="form-check-input" type="radio" {...register("level3", {
                                                validate: () => validateTechnology("laravel", "level3"),
                                            })} id="mid3" value="mideator" />
                                            <label className="form-check-label">Mideator</label>
                                        </div>
                                        <div className="col">
                                            <input className="form-check-input" type="radio" {...register("level3", {
                                    ...
                                    <div className="row">
                                        <div className="col">
                                            <input className="form-check-input" type="checkbox" value="oracle" id="oracle" {...register("oracle", {
                                                validate: () => validateTechnology("oracle", "level4"),
                                            })} />
                                        ...
                                        <div className="col">
                                            <input className="form-check-input" type="radio" {...register("level4", {
                                                validate: () => validateTechnology("oracle", "level4"),
                                            })} id="beg4" value="beginner" />
                                            <label className="form-check-label">Beginner</label>
                                        </div>
                                        <div className="col">
                                            <input className="form-check-input" type="radio" {...register("level4", {
                                                validate: () => validateTechnology("oracle", "level4"),
                                            })} id="mid4" value="mideator" />
                                            <label className="form-check-label">Mideator</label>
                                        </div>
                                        <div className="col">
                                            <input className="form-check-input" type="radio" {...register("level4", {
