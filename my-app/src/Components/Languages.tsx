            ...
            <td>
              <fieldset className="fieldset form-control" style={{ width: 500 }}>
                ...
                <div className="container_language_language">
                  <div className="row">
                    <div className="col"><input className="form-check-input" type="checkbox" value="php" id="php" {...register("php")} /><label className="form-check-label">Php</label></div>
                    <div className="col"><input className="form-check-input" type="radio" {...register("level1")} id="beg1" value="beginner" /><label className="form-check-label">Beginner</label></div>
                    <div className="col"><input className="form-check-input" type="radio" {...register("level1")} id="mid1" value="mideator" /><label className="form-check-label">Mideator</label></div>
                    <div className="col"><input className="form-check-input" type="radio" {...register("level1")} id="ex1" value="expert" /><label className="form-check-label">Expert</label></div>
                  </div>
                  <div className="row">
                    <div className="col"><input className="form-check-input" type="checkbox" value="mysql" id="mysql" {...register("mysql")} /><label className="form-check-label">Mysql</label></div>
                    <div className="col"><input className="form-check-input" type="radio" {...register("level2")} id="beg2" value="beginner" /><label className="form-check-label">Beginner</label></div>
                    <div className="col"><input className="form-check-input" type="radio" {...register("level2")} id="mid2" value="mideator" /><label className="form-check-label">Mideator</label></div>
                    <div className="col"><input className="form-check-input" type="radio" {...register("level2")} id="ex2" value="expert" /><label className="form-check-label">Expert</label></div>
                  </div>
                  <div className="row">
                    <div className="col"><input className="form-check-input" type="checkbox" value="laravel" id="laravel" {...register("laravel")} /><label className="form-check-label">laravel</label></div>
                    <div className="col"><input className="form-check-input" type="radio" {...register("level3")} id="beg3" value="beginner" /><label className="form-check-label">Beginner</label></div>
                    <div className="col
